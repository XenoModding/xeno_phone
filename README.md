...
Ein modernes und benutzerfreundliches Handy-Script für **FiveM**, entwickelt von **Xeno Modding**.  
Das Script bringt ein realistisches Smartphone-Erlebnis auf deinen Server – perfekt für Roleplay, Kommunikation und Immersion.

---

## 🚀 Funktionen

- 📞 Telefonieren und SMS-System  
- 💬 Kontakte speichern und verwalten  
- 🗺️ Integration mit GPS oder anderen Server-Systemen (optional)  
- ⚙️ Leicht konfigurierbar und einfach anzupassen  
- 🧩 Plug-and-Play – keine zusätzlichen Ressourcen erforderlich  

---

## 🧠 Installation

1. Lade den Ordner **xeno_phone** herunter.  
